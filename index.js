...
function validate_all(output) {
    ...
    errorlist = '';
    if (! t1) {
        errorlist += 'Please input a Username / Invalid<br />';
    }
    if (! t2) {
        errorlist += 'Please input a Password / Invalid<br />';
    }
    if (! t3) {
    ...
    document.getElementById("results").innerHTML='Registraton Complete';
